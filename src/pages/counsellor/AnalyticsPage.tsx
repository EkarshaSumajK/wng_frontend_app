        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Comprehensive insights across school, classes, and students</p>
            </div>
          </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overall" className="space-y-6">
          {overviewLoading ? (
            ...
            <OverallView data={overviewData} onSelectStudent={(id) => {
...
function OverallView({ data, onSelectStudent }: { data: SchoolOverview; onSelectStudent?: (id: string) => void }) {
                ...
                top_performers.slice(0, 5).map((student, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-orange-600">{student.daily_streak} days</span>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        <p className="font-bold text-red-600">{student.wellbeing_score}%</p>
