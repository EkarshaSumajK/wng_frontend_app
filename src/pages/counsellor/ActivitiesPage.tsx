...
const activityTypeColors: Record<string, string> = {
  PHYSICAL_DEVELOPMENT: 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800',
...
const diagnosisColors: Record<string, string> = {
  VISUAL_IMPAIRMENT: 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800',
  HEARING_IMPAIRMENT: 'bg-indigo-100 text-indigo-800 border-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-800',
  INTELLECTUAL_DISABILITIES: 'bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800',
  LEARNING_DISABILITIES: 'bg-pink-100 text-pink-800 border-pink-200 dark:bg-pink-900/30 dark:text-pink-300 dark:border-pink-800',
  ANXIETY_DISORDERS: 'bg-orange-100 text-orange-800 border-orange-200 dark:bg-orange-900/30 dark:text-orange-300 dark:border-orange-800',
  DEPRESSION: 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700',
  ADHD: 'bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-800',
  TRAUMA_PTSD: 'bg-red-100 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-300 dark:border-red-800',
  AUTISM_SPECTRUM_DISORDER: 'bg-teal-100 text-teal-800 border-teal-200 dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-800',
};
...
const diagnosisImages: Record<string, string> = {
  ...
  DEPRESSION: 'https://images.unsplash.com/photo-1499209974431-9dddcece7f88?q=80&w=1000&auto=format&fit=crop',
  ADHD: 'https://images.unsplash.com/photo-1550525811-e5869dd03032?q=80&w=1000&auto=format&fit=crop',
      ...
      {!selectedGrade && !selectedDiagnosis && !searchQuery && !viewAllType && selectedTypes.length === 0 ? (
        ...
        <div className="space-y-6">
          ...
          {viewAllType === 'grades' ? (
            ...
            <>
              {/* Filter Bar */}
              {/* Filter Bar - Styled like Browse Tab */}
              <div className="relative max-w-md mx-auto mb-8">
                <div className="flex gap-2">
                  {/* Search */}
